...
import { RandomEffects } from './random/random.effects'

export const appEffects = [CollectionsEffects, PhotoEffects, PhotosEffects, SearchEffects, TopicsEffects, StatsEffects, TopicPhotosEffects, RandomEffects];
